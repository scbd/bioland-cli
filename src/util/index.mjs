...
export { getCommand   , getBranch    , getArgs    , getAllUserArgs, isDev               } from './commands.mjs'
...
export { jsonApiDelete, jsonApiGet, patchMenuUri, login, deleteMenu, enableJsonApi, patch, deleteNode, post, get, getHost} from './drupal/json-api.mjs'
